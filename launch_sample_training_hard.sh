...
python gym-sted-pfrl/main.py --env gym_sted:STEDtimed-v4 --outdir ./data/sample_env_training_v4_hard --num-envs 20 --checkpoint_freq 1000 --bleach_sampling normal
