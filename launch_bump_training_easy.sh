...
python gym-sted-pfrl/main.py --env gym_sted:STEDtimed-v3 --outdir ./data/bump_env_training_v4_easy_2 --num-envs 20 --checkpoint_freq 1000 --bleach_sampling constant
