...
class timedExpSTEDEnv2BumpHard(gym.Env):
    """
    Creates a 'STEDEnv'
    ...
    ***
    This is the same exp env as timedExpSTEDEnvBump, except the fluorophore bleaching constants are sampled
    ***
    """
    metadata = {'render.modes': ['human']}
    obj_names = ["Resolution", "Bleach", "SNR", "NbNanodomains"]
...
class timedExpSTEDEnv2SampledFlash(gym.Env):
    """
    Creates a 'STEDEnv'
    ...
    ***
    This is the same exp env as timedExpSTEDEnv2, except the light curve is sampled from Theresa's data instead of
    the hand crafted light curve
    ***
    """
    metadata = {'render.modes': ['human']}
    obj_names = ["Resolution", "Bleach", "SNR", "NbNanodomains"]
...
class timedExpSTEDEnv2SampledFlashHard(gym.Env):
    """
    Creates a 'STEDEnv'
