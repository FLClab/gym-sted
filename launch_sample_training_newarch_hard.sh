...
python gym-sted-pfrl/transfer_learning_tests.py --env gym_sted:STEDtimed-hard-v4 --outdir ./data/sample_env_training_v3_hard --num-envs 20 --checkpoint_freq 1000
